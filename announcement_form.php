  ...
  <!-- HEADER END -->
   ...
   <!-- SIDEBAR END--> 
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i>Announcement Form</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="fvrc_president_login.php">Home</a></li>
						<li><i class="fa fa-file-text-o"></i>Announcement Form</li>
					</ol>
				</div>
			</div>
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <div class="panel-body">
                              <form class="form-horizontal" action="announcement_form2.php" method="POST">
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Date</label>
                                      <div class="col-sm-10">
                                          <input type="text" name="date" class="form-control" value="<?php include 'date.php'; ?>"required>
                                      </div>
                                  </div>
								  ...
								  <div class="form-group">
								    ...
								    <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">Content</label>
                                      <div class="col-lg-10">
                                         <textarea name="content" class="form-control m-bot15"></textarea>
										  
										 </div>
									  <center>
									   <button type="submit" name="btn_insert_new_club" class="btn btn-primary">Submit</button>
                      <a href="announcement_form.php" class="btn btn-danger">Cancel</a>
