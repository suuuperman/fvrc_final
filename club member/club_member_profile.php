...
?>
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="member_login.php" class="logo">Club <span class="lite">Member</span></a>
            <!--logo end-->
      ...
      <!--sidebar start-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
<a class="" href="member_login.php">
                          <i class="icon_house_alt"></i>
                          <span>Home</span>
                      </a>
                  </li>
				  <li class="sub-menu">
                        <a class="" href="member_accident_reports.php">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                        
						  ...
						  <li><a class="" href="member_view_all_clubs.php">View all clubs</a></li>
                      </ul>
                  </li>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="member_login.php">Home</a></li>
                          ...
                          <div class="panel-body">
                              <div class="tab-content">
								...
								<!-- ACCOUNT -->
                                          ...
                                          <div class="panel-body bio-graph-info">
                                              <h1> Background Profile </h1>
                                              <form class="form-horizontal" action="update_profile.php" method="POST" role="form">                                                  
                                          ...
                                          <div class="panel-body bio-graph-info">
                                              <h1> Volunteer Information </h1>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <input type="text" class="form-control" id="f-name" name="edit_firstname" value="<?php echo $row_information['firstname']; ?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
