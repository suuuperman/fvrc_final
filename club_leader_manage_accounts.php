      ...
      <!--sidebar start-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  <li class="active">
<a class="" href="club_leader__login.php">
                          <i class="icon_house_alt"></i>
                          <span>Home</span>
                      </a>
                  </li>
				  <li class="sub-menu">
                        <a class="" href="club_leader_accident_reports.php">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="club_leader_clubsAndMembers.html">Clubs and Members</a></li>
						  <li><a class="" href="club_leader_view_all_clubs.php">View all clubs</a></li>
                      </ul>
                  </li>
				  
				  <li>                     
                      <a class="" href="club_leader_all_fvrc_members.php">
                  ...
                  <li>                     
                      <a class="" href="club_leader_manage_positions.php">
                          <i class="!icon_piechart"></i>
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Manage Accounts</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="club_leader_login.php">Home</a></li>
						<li><i class="fa fa-bars"></i><a href="club_leader_manage_accounts.php">Manage Accounts</a></li>
			  ...
			  <br>
			   <header class="panel-heading">
							...
							if(isset($_POST['searching'])){
								$query1=mysql_query("SELECT * from `accounts` where `$_POST[category]` = '$_POST[keyword]'");
								
								$_SESSION['category']=$_POST['category'];
								$_SESSION['keyword']=$_POST['keyword'];
								$location="print_manage_accounts2.php";
							}else{
								$query1=mysql_query("SELECT * from `accounts`");
								
								$location="print_manage_accounts.php";
                          ...
                          <div style="background-color: white;" class="table-responsive">
                            <table class="table">
                              ...
                              <tbody>
                               ...
                               <?php  echo '<td class="td2">'."<a href='approve_accounts.php?id=".$row['id_no']."'>Change</a>".'</td>' ?>
							...
							?>
								 <a href="print_manage_accounts.php">Generate Report</a>
							<?php
