      ...
      <section id="main-content">
        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-bars"></i><a href="club_member_login.php" >Announcements   </a></li>           
          </ol>
        </div>
      </div>
      
               <div class="col-md-6 portlets" style="width: 100%; height: 60%;">
              <div class="panel panel-default">
                <div class="panel-body">
                  <div class="padd">
                    
            <?php
            $sql=mysql_query("SELECT * FROM `annoucement`"); 
                                          ...
                                          <div class="panel-body bio-graph-info">
                                              ...
                                              <form class="form-horizontal" action="manage_position3.php" method="POST" role="form" >                                                  
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <input type="text" class="form-control" disabled="disabled" name="id_number" id="f-name"  value="<?php echo $row['date']; ?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Subject</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" class="form-control" disabled="disabled" name="username" id="l-name"  value="<?php echo $row['subject']; ?>" placeholder=" ">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Content</label>
                                                      <div class="col-lg-6">
                               <textarea class="form-control " disabled="disabled" id="ccomment" value="<?php echo $row['content']; ?>" name="report_content" required> <?php echo $row['content']; ?> </textarea>
                                                      </div>
                                                  </div>
