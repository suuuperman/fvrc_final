...
?>
                          ...
                          <div class="panel-body">
                            <div class="col-lg-2 col-sm-2">
							  ...
							  <?php 
								...
								$query_account=mysql_query("SELECT * from `accounts` where `id_no`='$_GET[id]'");
								$query_information=mysql_query("SELECT * from `volunteer_information` where `id_no`='$_GET[id]'");
								$query_contact=mysql_query("SELECT * from `volunteer_contact` where `id_no`='$_GET[id]'");
								$query_resources=mysql_query("SELECT * from `volunteer_resources` where `id_no`='$_GET[id]'");
								$query_skills=mysql_query("SELECT * from `volunteer_skills` where `id_no`='$_GET[id]'");
  ...
  <div id="edit-profile" class="tab-pane">
    ...
    <div class="panel-body bio-graph-info">
          <h1> Background Profile </h1>
           <form class="form-horizontal" action="user_update_profile.php" method="POST" role="form">                                                  
          <div class="form-group">
          <label class="col-lg-2 control-label">Username</label>
           <div class="col-lg-6">
            <input type="text" class="form-control" id="f-name" name="edit_id" value="<?php echo $row_account['id_no']; ?>" readonly>
            </div>
          </div>
        ...
        <div class="form-group">
          <label class="col-lg-2 control-label">Password</label>
            <div class="col-lg-6">
        <input type="text" class="form-control" id="l-name" name="edit_password" value="<?php echo $row_account['password']; ?> ">
            </div>
        </div>
                                          ...
                                          <div class="panel-body bio-graph-info">
											 ...
											 <div class="form-group">
                                                      <div class="col-lg-offset-2 col-lg-10">
                                                          ...
                                                          <a href="all_fvrc_members.php" class="btn btn-danger">Cancel</a>
                                                      </div>
                                                  </div>
                                              </form>	  
